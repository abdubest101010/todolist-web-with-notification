            ...
            >
              <div>
                ...
                <p className="text-gray-500 text-xl">
                  Scheduled at: {task.scheduledAt} {/* Displaying local time */}
                </p>
              </div>
              <div className="flex justify-end space-x-2 mt-4">
                <Link
                  href={`/update-task/${task.id}`}
                  className="bg-yellow-500 text-white px-4 py-2 rounded text-lg flex items-center justify-center"
                >
                  Update
                </Link>
                <button
                  onClick={() => handleDelete(task.id)}
                  className="bg-red-500 text-white px-4 py-2 rounded text-lg flex items-center justify-center"
                >
                  Delete
                </button>
              </div>
